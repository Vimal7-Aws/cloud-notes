...
Below are the Big-O performance complexities of common operations for various **Java Collections**.
...
✅ **Notes**
- `h` = table capacity (number of buckets)
- `n` = number of entries
- Average case assumes good hash distribution
- “Next” refers to iterating through the next element (like an iterator)
